...
const countries = () => {
    ...
    const RemoveItem = ((RemoveItem)=>{
        ...
        const FilterDataCountry = filterdata.filter((filterCountry)=>filterCountry.name.common !== RemoveItem )
        setFilterdata(FilterDataCountry)
    })

    const searchDAta = ((searchDAta)=>{
    
        const newFilterData = countries.filter((country)=>{
            const countryName = country.name.common;
            return countryName.startsWith(searchDAta);
        })
